...
- [ ] (2026-08-26) The first credentialed Timber web slice has started. Its durable session, facade, local E2E, and approval-gated production work are tracked in [the browser-session ExecPlan](./2026-08-26-web-session-foundation.md).
...
- `/Users/alecgorge/code/relisten/relisten-web` is the Timber and Vite web app. It renders public playlist URLs first; a later credentialed web slice calls same-origin `relisten.net/api/user/v1/*` and never stores a Relisten bearer token.
