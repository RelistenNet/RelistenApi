...
curl -o search_result_pages/jg_gd_001.html "https://jerrygarcia.com/shows/?bid%5B3588%5D=on&kw&sd&ed&reg&stat&cty&ec&octy&srt=DO"
...
do
	...
	if ! [ -f "$FILE" ] ; then
		curl -A "$USER_AGENT" -o "$FILE" "https://jerrygarcia.com/shows/page/$i/?bid%5B3588%5D=on&kw&sd&ed&reg&stat&cty&ec&octy&srt=DO"	
	fi
done
