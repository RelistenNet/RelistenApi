...
namespace Relisten.Controllers
{
    ...
    public class ImportController : RelistenBaseController
    {
        ...
        public ImportController(RedisService redis, DbService db, SetlistFmImporter setlistFmImporter) : base(redis, db)
        {
        ...
        public async Task<IActionResult> Get(string idOrSlug)
        {
            ...
            if (art != null)
            {
                return JsonSuccess(await _setlistFmImporter.ImportDataForArtist(art));
            }
